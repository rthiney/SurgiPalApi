...
export class QuestionApi {
     ...
     */
    public questionIdDelete(id: string, extraHttpRequestParams?: any): Observable<number> {
        return this.questionIdDeleteWithHttpInfo(id, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param satisfy Should all filters match (default)? Or any?
     */
    public questionGetWithHttpInfo(exclude?: string, include?: string, order?: string, page?: string, transform?: boolean, columns?: string, filter[]?: Array<string>, satisfy?: string, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param id Identifier for item.
     */
    public questionIdDeleteWithHttpInfo(id: string, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param id Identifier for item.
     */
    public questionIdGetWithHttpInfo(id: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/question/${id}`;
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling questionIdGet.');
        }
    ...
    public questionIdPatchWithHttpInfo(id: string, item: models.Item83, extraHttpRequestParams?: any): Observable<Response> {
        ...
        if (item === null || item === undefined) {
            throw new Error('Required parameter item was null or undefined when calling questionIdPatch.');
        }
    ...
    public questionIdPutWithHttpInfo(id: string, item: models.Item82, extraHttpRequestParams?: any): Observable<Response> {
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling questionIdPut.');
        }
        // verify required parameter 'item' is not null or undefined
        if (item === null || item === undefined) {
            throw new Error('Required parameter item was null or undefined when calling questionIdPut.');
        }
    ...
    public questionPostWithHttpInfo(item: models.Item81, extraHttpRequestParams?: any): Observable<Response> {
        ...
        // verify required parameter 'item' is not null or undefined
        if (item === null || item === undefined) {
            throw new Error('Required parameter item was null or undefined when calling questionPost.');
        }
