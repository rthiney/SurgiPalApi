...
export class SpecialtyApi {
     ...
     */
    public specialtyIdDelete(id: string, extraHttpRequestParams?: any): Observable<number> {
        return this.specialtyIdDeleteWithHttpInfo(id, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param satisfy Should all filters match (default)? Or any?
     */
    public specialtyGetWithHttpInfo(exclude?: string, include?: string, order?: string, page?: string, transform?: boolean, columns?: string, filter[]?: Array<string>, satisfy?: string, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param id Identifier for item.
     */
    public specialtyIdDeleteWithHttpInfo(id: string, extraHttpRequestParams?: any): Observable<Response> {
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling specialtyIdDelete.');
        }
     ...
     * @param id Identifier for item.
     */
    public specialtyIdGetWithHttpInfo(id: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/specialty/${id}`;
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling specialtyIdGet.');
        }
    ...
    public specialtyIdPatchWithHttpInfo(id: string, item: models.Item89, extraHttpRequestParams?: any): Observable<Response> {
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling specialtyIdPatch.');
        }
        // verify required parameter 'item' is not null or undefined
        if (item === null || item === undefined) {
            throw new Error('Required parameter item was null or undefined when calling specialtyIdPatch.');
        }
    ...
    public specialtyIdPutWithHttpInfo(id: string, item: models.Item88, extraHttpRequestParams?: any): Observable<Response> {
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling specialtyIdPut.');
        }
        // verify required parameter 'item' is not null or undefined
        if (item === null || item === undefined) {
            throw new Error('Required parameter item was null or undefined when calling specialtyIdPut.');
        }
    ...
    public specialtyPostWithHttpInfo(item: models.Item87, extraHttpRequestParams?: any): Observable<Response> {
        ...
        // verify required parameter 'item' is not null or undefined
        if (item === null || item === undefined) {
            throw new Error('Required parameter item was null or undefined when calling specialtyPost.');
        }
