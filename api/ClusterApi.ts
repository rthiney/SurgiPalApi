...
export class ClusterApi {
     ...
     */
    public clusterIdDelete(id: string, extraHttpRequestParams?: any): Observable<number> {
        return this.clusterIdDeleteWithHttpInfo(id, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param satisfy Should all filters match (default)? Or any?
     */
    public clusterGetWithHttpInfo(exclude?: string, include?: string, order?: string, page?: string, transform?: boolean, columns?: string, filter[]?: Array<string>, satisfy?: string, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param id Identifier for item.
     */
    public clusterIdDeleteWithHttpInfo(id: string, extraHttpRequestParams?: any): Observable<Response> {
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling clusterIdDelete.');
        }
     ...
     * @param id Identifier for item.
     */
    public clusterIdGetWithHttpInfo(id: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/cluster/${id}`;
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling clusterIdGet.');
        }
    ...
    public clusterIdPatchWithHttpInfo(id: string, item: models.Item26, extraHttpRequestParams?: any): Observable<Response> {
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling clusterIdPatch.');
        }
        // verify required parameter 'item' is not null or undefined
        if (item === null || item === undefined) {
            throw new Error('Required parameter item was null or undefined when calling clusterIdPatch.');
        }
    ...
    public clusterIdPutWithHttpInfo(id: string, item: models.Item25, extraHttpRequestParams?: any): Observable<Response> {
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling clusterIdPut.');
        }
        // verify required parameter 'item' is not null or undefined
        if (item === null || item === undefined) {
            throw new Error('Required parameter item was null or undefined when calling clusterIdPut.');
        }
    ...
    public clusterPostWithHttpInfo(item: models.Item24, extraHttpRequestParams?: any): Observable<Response> {
        ...
        // verify required parameter 'item' is not null or undefined
        if (item === null || item === undefined) {
            throw new Error('Required parameter item was null or undefined when calling clusterPost.');
        }
