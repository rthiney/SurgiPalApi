...
export class CountryApi {
     ...
     */
    public countryIdDelete(id: string, extraHttpRequestParams?: any): Observable<number> {
        return this.countryIdDeleteWithHttpInfo(id, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param satisfy Should all filters match (default)? Or any?
     */
    public countryGetWithHttpInfo(exclude?: string, include?: string, order?: string, page?: string, transform?: boolean, columns?: string, filter[]?: Array<string>, satisfy?: string, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param id Identifier for item.
     */
    public countryIdDeleteWithHttpInfo(id: string, extraHttpRequestParams?: any): Observable<Response> {
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling countryIdDelete.');
        }
     ...
     * @param id Identifier for item.
     */
    public countryIdGetWithHttpInfo(id: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/country/${id}`;
    ...
    public countryIdPatchWithHttpInfo(id: string, item: models.Item35, extraHttpRequestParams?: any): Observable<Response> {
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling countryIdPatch.');
        }
        // verify required parameter 'item' is not null or undefined
        if (item === null || item === undefined) {
            throw new Error('Required parameter item was null or undefined when calling countryIdPatch.');
        }
    ...
    public countryIdPutWithHttpInfo(id: string, item: models.Item34, extraHttpRequestParams?: any): Observable<Response> {
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling countryIdPut.');
        }
        // verify required parameter 'item' is not null or undefined
        if (item === null || item === undefined) {
            throw new Error('Required parameter item was null or undefined when calling countryIdPut.');
        }
    ...
    public countryPostWithHttpInfo(item: models.Item33, extraHttpRequestParams?: any): Observable<Response> {
        ...
        // verify required parameter 'item' is not null or undefined
        if (item === null || item === undefined) {
            throw new Error('Required parameter item was null or undefined when calling countryPost.');
        }
