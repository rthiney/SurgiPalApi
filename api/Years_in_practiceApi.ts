...
@Injectable()
export class Years_in_practiceApi {
     ...
     */
    public yearsInPracticeGet(exclude?: string, include?: string, order?: string, page?: string, transform?: boolean, columns?: string, filter[]?: Array<string>, satisfy?: string, extraHttpRequestParams?: any): Observable<Array<models.InlineResponse20039>> {
        return this.yearsInPracticeGetWithHttpInfo(exclude, include, order, page, transform, columns, filter[], satisfy, extraHttpRequestParams)
     ...
     */
    public yearsInPracticeIdDelete(id: string, extraHttpRequestParams?: any): Observable<number> {
        return this.yearsInPracticeIdDeleteWithHttpInfo(id, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param id Identifier for item.
     */
    public yearsInPracticeIdGet(id: string, extraHttpRequestParams?: any): Observable<models.InlineResponse20039> {
        return this.yearsInPracticeIdGetWithHttpInfo(id, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param satisfy Should all filters match (default)? Or any?
     */
    public yearsInPracticeGetWithHttpInfo(exclude?: string, include?: string, order?: string, page?: string, transform?: boolean, columns?: string, filter[]?: Array<string>, satisfy?: string, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param id Identifier for item.
     */
    public yearsInPracticeIdDeleteWithHttpInfo(id: string, extraHttpRequestParams?: any): Observable<Response> {
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling yearsInPracticeIdDelete.');
        }
     ...
     * @param id Identifier for item.
     */
    public yearsInPracticeIdGetWithHttpInfo(id: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/years_in_practice/${id}`;
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling yearsInPracticeIdGet.');
        }
    ...
    public yearsInPracticeIdPatchWithHttpInfo(id: string, item: models.Item122, extraHttpRequestParams?: any): Observable<Response> {
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling yearsInPracticeIdPatch.');
        }
        // verify required parameter 'item' is not null or undefined
        if (item === null || item === undefined) {
            throw new Error('Required parameter item was null or undefined when calling yearsInPracticeIdPatch.');
        }
    ...
    public yearsInPracticeIdPutWithHttpInfo(id: string, item: models.Item121, extraHttpRequestParams?: any): Observable<Response> {
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling yearsInPracticeIdPut.');
        }
        // verify required parameter 'item' is not null or undefined
        if (item === null || item === undefined) {
            throw new Error('Required parameter item was null or undefined when calling yearsInPracticeIdPut.');
        }
    ...
    public yearsInPracticePostWithHttpInfo(item: models.Item120, extraHttpRequestParams?: any): Observable<Response> {
        ...
        // verify required parameter 'item' is not null or undefined
        if (item === null || item === undefined) {
            throw new Error('Required parameter item was null or undefined when calling yearsInPracticePost.');
        }
