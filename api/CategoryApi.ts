...
export class CategoryApi {
     ...
     */
    public categoryIdDelete(id: string, extraHttpRequestParams?: any): Observable<number> {
        return this.categoryIdDeleteWithHttpInfo(id, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param satisfy Should all filters match (default)? Or any?
     */
    public categoryGetWithHttpInfo(exclude?: string, include?: string, order?: string, page?: string, transform?: boolean, columns?: string, filter[]?: Array<string>, satisfy?: string, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param id Identifier for item.
     */
    public categoryIdDeleteWithHttpInfo(id: string, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param id Identifier for item.
     */
    public categoryIdGetWithHttpInfo(id: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/category/${id}`;
    ...
    public categoryIdPatchWithHttpInfo(id: string, item: models.Item20, extraHttpRequestParams?: any): Observable<Response> {
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling categoryIdPatch.');
        }
        // verify required parameter 'item' is not null or undefined
        if (item === null || item === undefined) {
            throw new Error('Required parameter item was null or undefined when calling categoryIdPatch.');
        }
    ...
    public categoryIdPutWithHttpInfo(id: string, item: models.Item19, extraHttpRequestParams?: any): Observable<Response> {
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling categoryIdPut.');
        }
        // verify required parameter 'item' is not null or undefined
        if (item === null || item === undefined) {
            throw new Error('Required parameter item was null or undefined when calling categoryIdPut.');
        }
    ...
    public categoryPostWithHttpInfo(item: models.Item18, extraHttpRequestParams?: any): Observable<Response> {
        ...
        // verify required parameter 'item' is not null or undefined
        if (item === null || item === undefined) {
            throw new Error('Required parameter item was null or undefined when calling categoryPost.');
        }
