...
export class Vendor_dataApi {
     ...
     */
    public vendorDataGet(exclude?: string, include?: string, order?: string, page?: string, transform?: boolean, columns?: string, filter[]?: Array<string>, satisfy?: string, extraHttpRequestParams?: any): Observable<Array<models.InlineResponse20037>> {
        return this.vendorDataGetWithHttpInfo(exclude, include, order, page, transform, columns, filter[], satisfy, extraHttpRequestParams)
     ...
     */
    public vendorDataIdDelete(id: string, extraHttpRequestParams?: any): Observable<number> {
        return this.vendorDataIdDeleteWithHttpInfo(id, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param id Identifier for item.
     */
    public vendorDataIdGet(id: string, extraHttpRequestParams?: any): Observable<models.InlineResponse20037> {
        return this.vendorDataIdGetWithHttpInfo(id, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param satisfy Should all filters match (default)? Or any?
     */
    public vendorDataGetWithHttpInfo(exclude?: string, include?: string, order?: string, page?: string, transform?: boolean, columns?: string, filter[]?: Array<string>, satisfy?: string, extraHttpRequestParams?: any): Observable<Response> {
     ...
     * @param id Identifier for item.
     */
    public vendorDataIdDeleteWithHttpInfo(id: string, extraHttpRequestParams?: any): Observable<Response> {
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling vendorDataIdDelete.');
        }
     ...
     * @param id Identifier for item.
     */
    public vendorDataIdGetWithHttpInfo(id: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/vendor_data/${id}`;
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling vendorDataIdGet.');
        }
    ...
    public vendorDataIdPatchWithHttpInfo(id: string, item: models.Item113, extraHttpRequestParams?: any): Observable<Response> {
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling vendorDataIdPatch.');
        }
        // verify required parameter 'item' is not null or undefined
        if (item === null || item === undefined) {
            throw new Error('Required parameter item was null or undefined when calling vendorDataIdPatch.');
        }
    ...
    public vendorDataIdPutWithHttpInfo(id: string, item: models.Item112, extraHttpRequestParams?: any): Observable<Response> {
        ...
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling vendorDataIdPut.');
        }
        // verify required parameter 'item' is not null or undefined
        if (item === null || item === undefined) {
            throw new Error('Required parameter item was null or undefined when calling vendorDataIdPut.');
        }
    ...
    public vendorDataPostWithHttpInfo(item: models.Item111, extraHttpRequestParams?: any): Observable<Response> {
        ...
        // verify required parameter 'item' is not null or undefined
        if (item === null || item === undefined) {
            throw new Error('Required parameter item was null or undefined when calling vendorDataPost.');
        }
